...
class SfcPortPairUowTest {
	...
	void test(final WireMockRuntimeInfo wmRuntimeInfo) {
		...
		//
		final VnffgPortPairTask nt = new VnffgPortPairTask();
		nt.setVimResourceId("");
		final SystemConnections sysConn = OsHelper.createConnection(wmRuntimeInfo);
		final VirtualTaskV3<VnffgPortPairTask> vt = new PortPairVt(nt);
		final SfcPortPairUow srv = new SfcPortPairUow(vt, sysConn);
		srv.rollback(null);
		assertTrue(true);
	}
...
class PortPairVt implements VirtualTaskV3<VnffgPortPairTask> {

	private final VnffgPortPairTask task;

	PortPairVt(final VnffgPortPairTask task) {
		this.task = task;
	}
	...
	@Override
	public VnffgPortPairTask getTemplateParameters() {
		return task;
	}

	@Override
	public void setTemplateParameters(final VnffgPortPairTask u) {
		// TODO Auto-generated method stub
	...
	@Override
	public void setSystemBuilder(final SystemBuilder<VnffgPortPairTask> db) {
		// TODO Auto-generated method stub

	}

	@Override
	public SystemBuilder<VnffgPortPairTask> getSystemBuilder() {
		// TODO Auto-generated method stub
		return null;
	}
